...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        List<Word> wordList = createSortedList(scanner);
    ...
    private static void printHistogram(List<Word> wordList) throws IOException {
    ...
    private static List<Word> createSortedList(Scanner scanner){
